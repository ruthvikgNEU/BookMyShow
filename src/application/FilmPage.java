...
public class FilmPage implements Initializable {
	...
	String id = vf.getId();
	    ...
	    public void initialize(URL location, ResourceBundle resources) {	
			...
			try {
				FileReader fr = new FileReader("/Users/ruthvikg/Downloads/3PointCinemas/3PointCinemas/films.txt");
...
//	            System.out.println(path + selectedFilm.getTitle() + ".png");
	    ...
	    public void deleteFilm(ActionEvent event) throws IOException {
	        ...
	        if(alert.getResult() == ButtonType.YES) {
	            ...
	            String tempFile = "/Users/ruthvikg/Downloads/3PointCinemas/3PointCinemas/temp.txt";
	            File oldFile = new File("/Users/ruthvikg/Downloads/3PointCinemas/3PointCinemas/films.txt");
	            File newFile = new File("/Users/ruthvikg/Downloads/3PointCinemas/3PointCinemas/temp.txt");
	            ...
	            oldFile.delete();
	            File dump = new File("/Users/ruthvikg/Downloads/3PointCinemas/3PointCinemas/films.txt");
