...
public class SendEmail { //Controller class which sends an email to the user
	...
	static void sendEmail(String recipient, String type) {
        ...
        final String username = "ruthvikroczz@gmail.com";
        final String password = "kfykyuloyncmuskt";
        ...
        String content = "Hello " + Confirmation.name + ",\n\n" +
                "Thank you for choosing 3Point Cinemas. Your booking for the film " + Main.getSelectedFilmTitle() + " has been confirmed."
    ...
    public static void writePdf(OutputStream outputStream) throws Exception {
        ...
        //Creates an Image and assigns the 3Point Cinemas logo to it
        Image img = Image.getInstance("/Users/ruthvikg/Downloads/3PointCinemas/3PointCinemas/Images/3PointCinemas_logo.png");
        img.scaleAbsolute(212f, 179.5f); //Resizes image
